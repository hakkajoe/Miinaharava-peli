...
class HighscoresViewEasy:
    ...
    def _start(self):
        ...
        self.button1 = ttk.Button(master=self._frame, text="Scores (medium)", command=self._show_mediumscores_view)
        ...
        if len(self._scores) == 0:
            ...
            self.intro_label = ttk.Label(master=self._frame, text="Top 10 (easy):")
