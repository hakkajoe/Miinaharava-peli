...
class HighscoresViewMedium:
    """handles actions in the medium highscore view interface
    """
    def __init__(self, root, show_mainmenu_view, show_easyscores_view, show_hardscores_view):
        """sets up interface

        Args:
            root: contains tkinter info
            show_mainmenu_view: info needed for showing main menu view
            show_easyscores_view: info needed for showing easy highscore view
        ...
        self._scores = score_service.get_scores("medium")
    ...
    def _start(self):
        ...
        self.button1 = ttk.Button(
            master=self._frame, text="Scores (easy)", command=self._show_easyscores_view)
        ...
        if len(self._scores) == 0:
            ...
            self.intro_label = ttk.Label(
                master=self._frame, text="Top 10 (medium):")
